module.exports = (function() {
    ...
    return {
        ...
        streamModalTemplate: fs.readFileSync('src/html/streamModal.html', 'utf8'),
        startStreamModalTemplate: fs.readFileSync('src/html/startStreamModal.html', 'utf8'),
        connectStreamModalTemplate: fs.readFileSync('src/html/connectStreamModal.html', 'utf8'),
        alreadyConnectedModalTemplate: fs.readFileSync('src/html/alreadyConnectedModal.html', 'utf8'),
        alreadyStreamingModalTemplate: fs.readFileSync('src/html/alreadyStreamingModal.html', 'utf8')
    };
})();
